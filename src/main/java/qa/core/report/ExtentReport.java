...
public class ExtentReport extends Report{
    ...
    private static void setExtentReports(String reportDir, String reportFileName) throws IOException{
    ...
    public static ExtentReport getInstance(String reportDir, String reportFileName) throws IOException{
